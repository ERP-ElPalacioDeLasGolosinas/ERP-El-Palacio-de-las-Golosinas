 ...
 * @property {string|null} tipo_deposito
...
export const DEPOSITO_COLUMNS =
  "id_deposito, nombre_deposito, direccion_deposito, telefono_deposito, tipo_deposito, horario_apertura, horario_cierre, id_responsable, activo, esta_lleno, creado, editado, creado_por";
